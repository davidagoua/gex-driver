...
class _MyDocument extends State<MyDocument> {
      ...
      child: new SafeArea(
        child: Container(
          ...
          child: Scaffold(
              ...
              appBar: AppBar(
                  title: Text(
                    getTranslated(context, LangConst.mydocumentlable).toString(),
                    maxLines: 1,
                    style: TextStyle(
                              ...
                              children: <Widget>[
                                Container(
                                  ...
                                  child: AppLableWidget(
                                    title:
                                        getTranslated(context, LangConst.vehicletypelable).toString(),
                                  ),
                                ),
                                Container(
                                    margin:
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      WidgetSpan(
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            getTranslated(context, LangConst.downloaddocumentlable).toString(),
                                                                            style:
                                                                                TextStyle(
                                ...
                                child: RichText(
                                  ...
                                  text: TextSpan(
                                    children: [
                                      WidgetSpan(
                                        child: Text(
                                            getTranslated(context, LangConst.yourfiletypelable).toString(),
                                            style: TextStyle(
                                                color:
                                                    Constants.whitetext,
                                                fontSize: 13,
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  child: Text(
                                      getTranslated(context, LangConst.makesurefilelable).toString(),
                                      maxLines: 3,
                                      overflow: TextOverflow.ellipsis,
                                      style: TextStyle(
                                          color: Constants.whitetext,
  ...
  void _downloadImage(String url, BuildContext context) async {
    ...
    GallerySaver.saveImage(path).then((bool? success) {
      setState(() {
        Constants.createSnackBar(getTranslated(context, LangConst.dowloaddocsucesslable).toString(),
